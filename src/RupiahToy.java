/**
 *
 *  @author  Muhammad Arief Irwansyah
 *
 */
...
public class RupiahToy {
    ...
    static void test01(){
        ...
        System.out.println(new RupiahToy(1000));
        System.out.println(new RupiahToy(9999));
        System.out.println(new RupiahToy(10000));
        System.out.println(new RupiahToy(99999));
        System.out.println(new RupiahToy(100000));
        System.out.println(new RupiahToy(999999));
        System.out.println(new RupiahToy(1000000));
        System.out.println(new RupiahToy(9999999));
        System.out.println(new RupiahToy(10000000));
        System.out.println(new RupiahToy(99999999));
        System.out.println(new RupiahToy(100000000));
        System.out.println(new RupiahToy(999999999));
        System.out.println(new RupiahToy(1000000000));
        System.out.println(new RupiahToy(9999999999L));
    }
