...
{
   String [] headers={"Id Pemesanan","Edisi","Judul ","Id Pelanggan","Nama Pelanggan","Alamat","Telephon","Jenis Kelamin","Jumlah Pesan","Tgl Bayar","Jml Bayar","Keterangan"};
   String[][] data;
   JTable tableView;
   int n;
   ...
   viewPembayaran()
   {
       super(" Laporan Pembayaran Media Umat");
   ...
   void koneksi()
   {
      try
      {
          ...
          while(rs.next())
          {
             ...
             data[m][10]=rs.getString(11);
             data[m][11]=rs.getString(12);
             m++;
          }
          state.close();
          con.close();
